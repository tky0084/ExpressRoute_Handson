...
> ℹ️ 構築範囲<br>
> 下図の赤枠の部分です。回線は後ほど作成します。

![alt text](</img/スクリーンショット 2026-02-25 213927.png>)
...
必要であれば、「編集」より、defaultサブネットのIPアドレス範囲を/27に設定する<br>
...
※IPアドレス範囲は/26を指定する <br>


> ℹ️ 開始アドレスについて<br>
> defaultサブネットが/27の場合、32からスタートしましょう
...
> ⚠️ 高額リソースです<br>
> 検証が終わり次第、削除し忘れないようご注意ください。<br>
> デプロイ完了まで30分ほどかかるので、デプロイ中にOCI環境の作成を進めましょう！
