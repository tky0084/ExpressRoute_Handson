...
![alt text](<i/mg/スクリーンショット 2026-02-25 213825.png>)
...
ネットワーク画面にて「セキュリティ」タブ → 「セキュリティ・リスト」欄から、デフォルトで存在するセキュリティ・リストを選択する。<br>
...
作成したインスタンスにての「ネットワーキング」タブにて、インターネットへのパブリックサブネットの接続から、「接続」を押下する
...
![alt text](<スクリーンショット 2026-02-25 212244.png>)<br>
