...
![alt text](</img/スクリーンショット 2026-02-25 214019.png>)
...
![alt text](</img/スクリーンショット 2026-02-14 063558.png>)<br>
...
![alt text](</img/スクリーンショット 2026-02-25 210343.png>)
...
> ℹ️ BGP IPアドレスについて<br>
> 本手順では仮に、「10.255.255.22/30、10.255.255.21/30、10.255.255.26/30、10.255.255.25/30」としています
...
---
### ExpressRouteGatewayの設定確認

ExpressRouteGatewayの  「設定」→「構成」より  「リモート仮想ネットワークからのトラフィックを許可します。」  にチェックを入れる。
